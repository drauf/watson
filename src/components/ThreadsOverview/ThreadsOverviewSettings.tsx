...
const ThreadsOverviewSettings: React.SFC<ThreadsOverviewSettingsProps> = ({ nonJvm, tomcat,
  nonTomcat, database, lucene, nameFilter, stackFilter, onFilterChange, onRegExpChange }) => (
