 ...
 */
export const matchesNameFilter = (thread: Thread, nameFilter: string | null | undefined): boolean => {
  if (!nameFilter) {
    return true;
  }
 ...
 */
export const matchesStackFilter = (thread: Thread, stackFilter: string | null | undefined): boolean => {
  if (!stackFilter) {
    return true;
  }
...
export const matchesRegexFilters = (
  ...
  stackFilter: string | null | undefined,
): boolean => matchesNameFilter(thread, nameFilter) && matchesStackFilter(thread, stackFilter);
